...
{
    wp_enqueue_style('screenly-admin_init', '/wp-content/plugins/screenly-cast/inc/assets/css/style.css', 'style');
...
function srly_get_css_settings_from_db() {
    ...
    $srly_brand_logo_width_db= get_option('srly_brand_logo_width');
    $srly_brand_logo_height_db = get_option('srly_brand_logo_height');
	
    $srly_h1_margin_db =  get_option('srly_h1_margin');
    $srly_h1_font_size_db = get_option('srly_h1_font_size');
    $srly_h1_font_weight_db = get_option('srly_h1_font_weight');
	
    $srly_time_font_size_db= get_option('srly_time_font_size');
	
    $srly_content_margin_top_db= get_option('srly_content_margin_top');
    $srly_content_line_height_db= get_option('srly_content_line_height');
    $srly_content_font_size_db= get_option('srly_content_font_size');
	
    $srly_blockquote_font_size_db= get_option('srly_blockquote_font_size');
	
    $srly_h23456_margin_db = get_option('srly_h23456_margin');
	
    $srly_h2_font_size_db= get_option('srly_h2_font_size');
    $srly_h4_font_size_db= get_option('srly_h4_font_size');
    $srly_h5_font_size_db= get_option('srly_h5_font_size');
    $srly_h6_font_size_db= get_option('srly_h6_font_size');
    
    $srly_brand_logo_width=!empty($srly_brand_logo_width_db)? $srly_brand_logo_width_db."px": "";    
    $srly_brand_logo_height = !empty($srly_brand_logo_height_db)? $srly_brand_logo_height_db."px":"";
	
    $srly_h1_margin =  !empty($srly_h1_margin_db)? $srly_h1_margin_db."px":"";
    $srly_h1_font_size = !empty($srly_h1_font_size_db)? $srly_h1_font_size_db."px":"";
    $srly_h1_font_weight = !empty($srly_h1_font_weight_db)? $srly_h1_font_weight_db."px":"";
	
    $srly_time_font_size= !empty($srly_time_font_size_db)? $srly_time_font_size_db."px":"";
	
    $srly_content_margin_top= !empty($srly_content_margin_top_db)?  $srly_content_margin_top_db."px":"";
    $srly_content_line_height= !empty($srly_content_line_height_db)? $srly_content_line_height_db."px":"";
    $srly_content_font_size= !empty($srly_content_font_size_db)? $srly_content_font_size_db."px":"";
	
    $srly_blockquote_font_size= !empty( $srly_blockquote_font_size_db)? $srly_blockquote_font_size_db."px":"";
	
    $srly_h23456_margin = !empty( $srly_h23456_margin_db)? $srly_h23456_margin_db."px":"";
	
    $srly_h2_font_size= !empty($srly_h2_font_size_db)? $srly_h2_font_size_db."px":"";
    $srly_h4_font_size= !empty($srly_h4_font_size_db)? $srly_h4_font_size_db."px":"";
    $srly_h5_font_size= !empty( $srly_h5_font_size_db)? $srly_h5_font_size_db."px":"";
    $srly_h6_font_size= !empty( $srly_h6_font_size_db)? $srly_h6_font_size_db."px":"";   
